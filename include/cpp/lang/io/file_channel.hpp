...
public:    
    ...
    /**
     * Закрывает десткриптор файла связанный с этим объектом.
     */
    ~file_channel();
     ...
     * 
     * @note
     *      Эта функция предпочтительнее, поскольку она генерирует исключения в случае ошибка.
     *      Деструктор игнорирует любые ошибки, и их невозможно обработать.
     * 
     * @throws io_exception
