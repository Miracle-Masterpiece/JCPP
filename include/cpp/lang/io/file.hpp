...
public:
     ...
     * 
     * @param new_name - UTF-8 строка с новым именем.
     * @param new_name_length - необязательный параметр, обозначающий длину строки.
     *                          -1 означает, что длина будет вычислина автоматически.
     * 
     * @return 
     ...
     * @return путь до папки с исполняемым файлом.
     */
